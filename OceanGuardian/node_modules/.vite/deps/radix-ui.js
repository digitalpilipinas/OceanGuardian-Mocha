import {
  ...
  useEffectEvent,
  useLayoutEffect2
} from "./chunk-JSCVTQTE.js";
import {
  require_jsx_runtime
} from "./chunk-WQUZVXOW.js";
import {
  require_react_dom
} from "./chunk-F4NCUFXK.js";
import {
  require_react
} from "./chunk-FAXX4WQY.js";
import {
  __commonJS,
  __export,
  __toESM
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React51 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState30 = React51.useState, useEffect33 = React51.useEffect, useLayoutEffect5 = React51.useLayoutEffect, useDebugValue = React51.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var Avatar = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React20.useState("idle");
    return (0, import_jsx_runtime9.jsx)(
      AvatarProvider,
      {
        ...
        children: (0, import_jsx_runtime9.jsx)(Primitive.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime9.jsx)(Primitive.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React20.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React20.useState(delayMs === void 0);
    React20.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime9.jsx)(Primitive.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React20.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React20.useState(
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React23.useState(null);
  const [bubbleInput, setBubbleInput] = React23.useState(null);
...
var CheckboxTrigger = React23.forwardRef(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
          ...
          isFormControl2 && (0, import_jsx_runtime10.jsx)(
            CheckboxBubbleInput,
            {
              __scopeCheckbox
            }
...
var CheckboxBubbleInput = React23.forwardRef(
...
var RovingFocusGroup = React27.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime13.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime13.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime13.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React28.useRef(false);
  ...
  return (0, import_jsx_runtime14.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime14.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
      ...
      children: (0, import_jsx_runtime14.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React28.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime14.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime14.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime14.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime14.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
var MenuRootContentModal = React28.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
...
var MenuRootContentNonModal = React28.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
  return (0, import_jsx_runtime14.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React28.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React28.useState(null);
    const contentRef = React28.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React28.useRef(0);
    const searchRef = React28.useRef("");
    const pointerGraceTimerRef = React28.useRef(0);
    const pointerGraceIntentRef = React28.useRef(null);
    const pointerDirRef = React28.useRef("right");
    const lastPointerXRef = React28.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React28.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React28.useCallback((event) => {
    ...
    return (0, import_jsx_runtime14.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React28.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React28.useCallback(
          (event) => {
        ...
        onPointerGraceIntentChange: React28.useCallback((intent) => {
...
var MenuGroup = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React28.useState("");
    React28.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
    ...
    return (0, import_jsx_runtime14.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime14.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime14.jsx)(
          Primitive.div,
          {
            role: "menuitem",
...
var MenuCheckboxItem = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React28.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React28.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React28.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React28.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React28.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React28.useEffect(() => {
...
var MenuSubContent = React28.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME6, props.__scopeMenu);
    ...
    const ref = React28.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime14.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime14.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime14.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime14.jsx)(
      MenuContentImpl,
      {
...
var ContextMenuTrigger = React29.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React29.useRef({ x: 0, y: 0 });
    const virtualRef = React29.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React29.useRef(0);
    const clearLongPress = React29.useCallback(
    ...
    React29.useEffect(() => clearLongPress, [clearLongPress]);
    React29.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React29.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React29.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React29.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React29.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React29.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React29.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React29.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React29.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React29.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React29.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React29.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React29.forwardRef((props, forwardedRef) => {
...
var NAME4 = "Label";
var Label3 = React31.forwardRef((props, forwardedRef) => {
...
var Form = React32.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, onClearServerErrors = () => {
    }, ...rootProps } = props;
    const formRef = React32.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React32.useState({});
    const getFieldValidity = React32.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React32.useCallback(
    ...
    const handleFieldValiditionClear = React32.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React32.useState({});
    const getFieldCustomMatcherEntries = React32.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React32.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React32.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React32.useState({});
    const getFieldCustomErrors = React32.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React32.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React32.useState({});
    const handleFieldMessageIdAdd = React32.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React32.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React32.useCallback(
...
var FormField = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const id = useId();
    return (0, import_jsx_runtime18.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime18.jsx)(
      Primitive.div,
      {
...
var FormLabel = React32.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React32.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React32.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React32.forwardRef(
  (props, forwardedRef) => {
    const { match, name: nameProp, ...messageProps } = props;
    const fieldContext = useFormFieldContext(MESSAGE_NAME, props.__scopeForm);
    const name = nameProp ?? fieldContext.name;
    if (match === void 0) {
      return (0, import_jsx_runtime18.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime18.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime18.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime18.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React32.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime18.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Primitive.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime18.jsx)(import_jsx_runtime18.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React32.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime18.jsx)(Primitive.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React33.useRef(false);
  const isPointerDownOnContentRef = React33.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React33.useCallback(() => setOpen(false), [setOpen]);
  React33.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
  ...
  return (0, import_jsx_runtime19.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime19.jsx)(Root25, { ...popperScope, children })
    }
  );
};
HoverCard.displayName = HOVERCARD_NAME;
var TRIGGER_NAME8 = "HoverCardTrigger";
var HoverCardTrigger = React33.forwardRef(
  (props, forwardedRef) => {
    const { __scopeHoverCard, ...triggerProps } = props;
    const context = useHoverCardContext(TRIGGER_NAME8, __scopeHoverCard);
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime19.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime19.jsx)(
      Primitive.a,
      {
        "data-state": context.open ? "open" : "closed",
        ...triggerProps,
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)(PortalProvider3, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Portal, { asChild: true, container, children }) }) });
};
HoverCardPortal.displayName = PORTAL_NAME6;
var CONTENT_NAME9 = "HoverCardContent";
var HoverCardContent = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(
...
var HoverCardContentImpl = React33.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React33.useState(false);
  React33.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React33.forwardRef(
  (props, forwardedRef) => {
...
var Menubar = React34.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React34.useState(null);
    return (0, import_jsx_runtime20.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React34.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React34.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React34.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime20.jsx)(Collection4.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime20.jsx)(Collection4.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime20.jsx)(
          Root8,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React34.useRef(false);
...
var MenubarTrigger = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsx)(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime20.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var MenubarGroup = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React34.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React34.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React34.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React35.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React35.useState(null);
    const composedRef = useComposedRefs(forwardedRef, (node) => setNavigationMenu(node));
    const direction = useDirection(dir);
    const openTimerRef = React35.useRef(0);
    const closeTimerRef = React35.useRef(0);
    const skipDelayTimerRef = React35.useRef(0);
    const [isOpenDelayed, setIsOpenDelayed] = React35.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React35.useCallback(() => {
...
var NavigationMenuSub = React35.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
    ...
    return (0, import_jsx_runtime21.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime21.jsx)(Primitive.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React35.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React35.useState(null);
  return (0, import_jsx_runtime21.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React35.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React35.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
      ...
      children: (0, import_jsx_runtime21.jsx)(Collection5.Provider, { scope, children: (0, import_jsx_runtime21.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
var LIST_NAME = "NavigationMenuList";
var NavigationMenuList = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...listProps } = props;
    const context = useNavigationMenuContext(LIST_NAME, __scopeNavigationMenu);
    const list = (0, import_jsx_runtime21.jsx)(Primitive.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime21.jsx)(Primitive.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime21.jsx)(Collection5.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime21.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
...
var NavigationMenuItem = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React35.useRef(null);
    const restoreContentTabOrderRef = React35.useRef(() => {
    });
    const wasEscapeCloseRef = React35.useRef(false);
    const handleContentEntry = React35.useCallback((side = "start") => {
    ...
    const handleContentExit = React35.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
    ...
    return (0, import_jsx_runtime21.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime21.jsx)(Primitive.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React35.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React35.useRef(false);
  const open = itemContext.value === context.value;
  return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
    (0, import_jsx_runtime21.jsx)(Collection5.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime21.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime21.jsx)(
      Primitive.button,
      {
        id: triggerId,
        disabled,
    ...
    open && (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
      ...
      context.viewport && (0, import_jsx_runtime21.jsx)("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, active, onSelect, ...linkProps } = props;
    return (0, import_jsx_runtime21.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime21.jsx)(
      Primitive.a,
      {
...
var NavigationMenuIndicator = React35.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? import_react_dom2.default.createPortal(
    (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || isVisible, children: (0, import_jsx_runtime21.jsx)(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }),
    context.indicatorTrack
  ) : null;
});
NavigationMenuIndicator.displayName = INDICATOR_NAME5;
var NavigationMenuIndicatorImpl = React35.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React35.useState(
    null
  );
  const [position, setPosition] = React35.useState(null);
  ...
  return position ? (0, import_jsx_runtime21.jsx)(
    Primitive.div,
    {
      "aria-hidden": true,
...
var NavigationMenuContent = React35.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
  ...
  return !context.viewport ? (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime21.jsx)(
  ...
  ) }) : (0, import_jsx_runtime21.jsx)(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
NavigationMenuContent.displayName = CONTENT_NAME11;
var ViewportContentMounter = React35.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React35.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React35.useRef(null);
  ...
  const motionAttribute = React35.useMemo(() => {
    const items = getItems();
  ...
  return (0, import_jsx_runtime21.jsx)(FocusGroup, { asChild: true, children: (0, import_jsx_runtime21.jsx)(
    DismissableLayer,
    {
      id: contentId,
...
var NavigationMenuViewport = React35.forwardRef((props, forwardedRef) => {
  const { forceMount, ...viewportProps } = props;
  const context = useNavigationMenuContext(VIEWPORT_NAME, props.__scopeNavigationMenu);
  const open = Boolean(context.value);
  return (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime21.jsx)(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
NavigationMenuViewport.displayName = VIEWPORT_NAME;
var NavigationMenuViewportImpl = React35.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React35.useState(null);
  ...
  return (0, import_jsx_runtime21.jsx)(
    Primitive.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime21.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const context = useNavigationMenuContext(FOCUS_GROUP_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime21.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime21.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime21.jsx)(Primitive.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
var ARROW_KEYS = ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown"];
var FOCUS_GROUP_ITEM_NAME = "FocusGroupItem";
var FocusGroupItem = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const getItems = useFocusGroupCollection(__scopeNavigationMenu);
    const context = useNavigationMenuContext(FOCUS_GROUP_ITEM_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime21.jsx)(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime21.jsx)(
      Primitive.button,
      {
        ...groupProps,
        ref: forwardedRef,
...
var OneTimePasswordField = React36.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React36.useCallback(
      (value2) => {
    ...
    const controlledValue = React36.useMemo(() => {
    ...
    const validationTypeRef = React36.useRef(validation);
    React36.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React36.useRef(null);
    const userActionRef = React36.useRef(null);
    ...
    const locateForm = React36.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React36.useCallback(() => {
    ...
    const valueRef = React36.useRef(currentValue);
    ...
    return (0, import_jsx_runtime22.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime22.jsx)(Collection6.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime22.jsx)(Collection6.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime22.jsx)(
          Root8,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React36.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React36.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React36.useState(null);
  ...
  const keyboardActionTimeoutRef = React36.useRef(null);
  React36.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime22.jsx)(Collection6.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime22.jsx)(
    Item2,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React37.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React37.useCallback(
  ...
  const focusState = React37.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React37.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React37.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React37.useState(void 0);
    const elementRef = React37.useRef(null);
...
var PasswordToggleFieldIcon = React37.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime24.jsx)(
    PopoverProvider,
    {
...
var PopoverAnchor = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
    const trigger = (0, import_jsx_runtime24.jsx)(
      Primitive.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime24.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime24.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime24.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime24.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime24.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime24.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime24.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime25.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React39.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime26.jsx)(
        RadioBubbleInput,
        {
          control: button,
...
var RadioIndicator = React40.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME7, __scopeRadio);
    return (0, import_jsx_runtime26.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime26.jsx)(
      Primitive.span,
      {
...
var RadioBubbleInput = React40.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime27.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
...
function useStateMachine(initialState, machine) {
  return React41.useReducer((state, event) => {
    ...
    return (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
      ...
      (0, import_jsx_runtime28.jsx)(
        Primitive.div,
        {
          ...
          children: (0, import_jsx_runtime28.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime28.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime28.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime28.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime28.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime28.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime28.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime28.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime28.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime28.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime28.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime28.jsx)(
    Primitive.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime29.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime29.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime29.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime29.jsx)(
          SelectNativeOptionsProvider,
          {
            scope: props.__scopeSelect,
            onNativeOptionAdd: React42.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React42.useCallback((option) => {
        ...
        isFormControl2 ? (0, import_jsx_runtime29.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime29.jsx)("option", { value: "" }) : null,
...
var SelectTrigger = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime29.jsx)(
      Primitive.button,
      {
        type: "button",
        role: "combobox",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime29.jsx)(import_jsx_runtime29.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME9 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime29.jsx)(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM3.createPortal(
        (0, import_jsx_runtime29.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime29.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime29.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime29.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime29.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime29.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
      ...
      (0, import_jsx_runtime29.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime29.jsx)(
        Primitive.div,
        {
...
var SelectGroup = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime29.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime29.jsx)(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React42.useMemo(
      () => (0, import_jsx_runtime29.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
      (0, import_jsx_runtime29.jsx)(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime29.jsx)(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React42.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? (0, import_jsx_runtime29.jsx)(
...
var SelectScrollDownButton = React42.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? (0, import_jsx_runtime29.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectSeparator = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime29.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
...
var Separator4 = React43.forwardRef((props, forwardedRef) => {
...
var Slider = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React44.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React44.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React44.useRef(values);
    ...
    return (0, import_jsx_runtime31.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime31.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime31.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime31.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React44.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React44.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React44.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React44.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React44.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React44.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React44.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React44.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React44.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React44.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime31.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
var SliderThumbImpl = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime31.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime31.jsx)(
            Primitive.span,
            {
              role: "slider",
...
var SliderBubbleInput = React44.forwardRef(
...
var Switch = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
...
var TabsList = React46.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React46.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React46.useRef(isSelected);
    React46.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime33.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime33.jsx)(
      Primitive.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
var Toolbar = React49.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime36.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime36.jsx)(
      Root8,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React49.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React49.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime36.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime36.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React49.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime36.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime36.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React49.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React49.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime36.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime36.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var Tooltip = (props) => {
  ...
  return (0, import_jsx_runtime37.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime37.jsx)(
...
var TooltipTrigger = React50.forwardRef(
  (props, forwardedRef) => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime37.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime37.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime37.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime37.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime37.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime37.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React50.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  ...
  const handleCreateGraceArea = React50.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime37.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable2 = createSlottable("TooltipContent");
var TooltipContentImpl = React50.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime37.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime37.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime37.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime37.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime37.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime37.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
